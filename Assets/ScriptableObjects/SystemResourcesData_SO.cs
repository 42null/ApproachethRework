...
{
    [CreateAssetMenu(fileName = "SystemResourceHolder", menuName = "ScriptableObjects/SystemResourceHolder")]
    public class DeckData : ScriptableObject
    {

        private ElementData[] cards; //the deck of actual cards, needs to be shuffled
        private int currentCard = 0;

        public void CardsRetrieved(List<ElementData> cardDataDownloaded)
        {
        ...
        public ElementData GetNextCardFromDeck()
        {
            //advance the index
            currentCard++;
